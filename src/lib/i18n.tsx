...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    "onboarding.step1.camera": "Cámara",
    "onboarding.step1.gallery": "Galería",
    "onboarding.step1.analyzing": "Analizando ingredientes con IA...",
    "onboarding.step1.detected": "Ingredientes detectados",
    "onboarding.step1.added": "Ingredientes agregados a la lista",
    "onboarding.step1.addAll": "Agregar todos a mi lista",
  ...
  en: {
    ...
    "onboarding.step1.camera": "Camera",
    "onboarding.step1.gallery": "Gallery",
    "onboarding.step1.analyzing": "Analyzing ingredients with AI...",
    "onboarding.step1.detected": "Detected ingredients",
    "onboarding.step1.added": "Ingredients added to list",
    "onboarding.step1.addAll": "Add all to my list",
